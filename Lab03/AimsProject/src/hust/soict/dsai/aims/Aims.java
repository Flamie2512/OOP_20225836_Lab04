package lab04.Aimsproject.hust.soict.hedspi.aims;
import java.util.ArrayList;
import java.util.Collections;
import java.util.Scanner;
import lab04.Aimsproject.hust.soict.hedspi.aims.media.*;
import lab04.Aimsproject.hust.soict.hedspi.aims.store.Store;
import lab04.Aimsproject.hust.soict.hedspi.aims.cart.Cart;   
public class aims {
        ...
        public static void showMenu() {
            System.out.println("Hi Tran Hoang Hien(20225836),");
        ...
        public static void mediaDetailsMenu(Media media) {
            System.out.println("Hi Tran Manh Hung(20220068),");
            System.out.println("Options: ");
            System.out.println("--------------------------------");
